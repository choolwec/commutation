...
export const TRIVIA: TriviaQuestion[] = [
  { q: "What is the capital city of Zambia?", options: ["Livingstone", "Lusaka", "Ndola", "Kitwe"], answer: 1 },
  ...
  { q: "In which sport would you perform a slam dunk?", options: ["Volleyball", "Basketball", "Netball", "Handball"], answer: 1 },
  ...
  { q: "Which social media app is known for short videos and a 'For You' page?", options: ["LinkedIn", "TikTok", "Pinterest", "Reddit"], answer: 1 },
  ...
  { q: "What does 'RSVP' stand for, roughly?", options: ["Reply please", "Reserve seating", "Respond if you can", "Please respond"], answer: 3 },
  { q: "Which vitamin do you get from sunlight?", options: ["Vitamin A", "Vitamin B12", "Vitamin C", "Vitamin D"], answer: 3 },
