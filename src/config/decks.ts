...
export const DARES = {
  warm: [
    ...
    "Give everyone in the room a fist bump using only your elbows — no exceptions.",
    "Let the room's chosen person give you bunny ears for a photo, arm around your shoulder.",
    "Sit on the lap of whoever the room picks for one full round — they can decline, room picks again.",
    "High-five your way around the entire room, ending on your loudest one yet.",
    "Give a two-second hug to whoever the room picks — arms only, no lingering.",
    "Let the room pick two people to link arms with you for the next round, wherever you go.",
    "Give whoever the room picks a piggyback ride once around the room.",
    "Sit knee-to-knee with whoever the room picks and have a 20-second staring contest — first to laugh takes a forfeit.",
  ...
  real: [
    ...
    "Let the room pick someone to give you a 60-second shoulder massage.",
    "Hold hands with the person across from you for the rest of this round, no matter what happens.",
    "Let whoever the room picks whisper something in your ear — keep a straight face or take a forfeit.",
    "Feed a bite of something to whoever the room picks, no hands, no talking.",
    "Trace the alphabet on the back of someone's hand — room picks who — they have to guess every letter.",
    "Give a real, 15-second hug to whoever the room picks — no letting go early, no counting out loud.",
  ...
  reckless: [
    ...
    "Kiss whoever the room picks — cheek or lips is their call, and either of you can veto it down to a hug.",
    "Straddle the lap of whoever the room picks for one full minute, facing them — either person can end it early.",
    "Sit face-to-face in the lap of whoever the room picks for two full minutes while the room counts — either person can call it off.",
    "Let the room pick two people to sandwich-hug you for 30 seconds.",
    "Trade an item of clothing with whoever the room picks — jacket, hat, shoes — and wear theirs for the rest of the game.",
    "Make out with whoever the room picks for 10 seconds — both people have to agree first, or it becomes a cheek kiss instead.",
